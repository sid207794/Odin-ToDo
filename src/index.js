  ...
  if (listArray.length === 0) {
    (function startupLists() {
      (function personal() {
        ...
        const personalFooter = document.querySelector(
          "#content .list .footerInputBox #footerInput"
        );
        const personalTaskReminder = document.querySelector(
          "#content .list .footerInputBox .reminder"
        );
        const personalTaskPriority = document.querySelector(
          "#content .list .footerInputBox .priority"
        );
        const personalTaskSubmitTime = document.querySelector(
          "#content .list .footerInputBox .submitTime"
        );
        const personalcloseBtn = document.querySelector(
          "#content .list .footerInputBox .close"
        );
        const personalAddTask = document.querySelector(
          "#content .list .footerInputBox .addTask"
        );
        ...
        const personalTodayTasks = document.querySelectorAll(
          "#content .list .today .task"
        );
        const secondTask = personalTodayTasks[1];
        const personaltaskUID = secondTask.classList[0];
        const personalTodayCheckbox = document.querySelector(
          `#content .list .today input#${CSS.escape(personaltaskUID)}`
        );
      ...
      (function grocery() {
        ...
        submitBtn.click();
        localStorage.setItem("todoData", JSON.stringify(listArray));
        const groceryFooter = document.querySelector(
          "#content .list .footerInputBox #footerInput"
        );
        const groceryTaskReminder = document.querySelector(
          "#content .list .footerInputBox .reminder"
        );
        const groceryTaskPriority = document.querySelector(
          "#content .list .footerInputBox .priority"
        );
        const groceryTaskSubmitTime = document.querySelector(
          "#content .list .footerInputBox .submitTime"
        );
        const grocerycloseBtn = document.querySelector(
          "#content .list .footerInputBox .close"
        );
        const groceryAddTask = document.querySelector(
          "#content .list .footerInputBox .addTask"
        );
        const todayH3 = document.querySelector("#content .list .today h3");
        ...
        const groceryTodayTasks = document.querySelectorAll(
          "#content .list .today .task"
        );
        const secondTask = groceryTodayTasks[1];
        const grocerytaskUID = secondTask.classList[0];
        const groceryTodayCheckbox = document.querySelector(
          `#content .list .today input#${CSS.escape(grocerytaskUID)}`
        );
      ...
      const PersonalList = document.querySelector(
        `#sidebar .myList .${CSS.escape(itemUID)}.item`
      );
      PersonalList.click();
      localStorage.setItem("todoData", JSON.stringify(listArray));
      const personalTodayTasks = document.querySelectorAll(
